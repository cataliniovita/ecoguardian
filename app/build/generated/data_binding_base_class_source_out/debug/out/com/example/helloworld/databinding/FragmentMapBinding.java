...
public final class FragmentMapBinding implements ViewBinding {
  ...
  private FragmentMapBinding(@NonNull ConstraintLayout rootView, @NonNull CardView locationCard,
      @NonNull TextView locationTextView, @NonNull MaterialButton refreshButton) {
  ...
  public static FragmentMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMapBinding((ConstraintLayout) rootView, locationCard, locationTextView,
          refreshButton);
    }
